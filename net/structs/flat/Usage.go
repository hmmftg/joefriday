...
func (rcv *Usage) Interfaces(obj *Interface, j int) bool {
...
func (rcv *Usage) InterfacesLength() int {
	o := flatbuffers.UOffsetT(rcv._tab.Offset(8))
	if o != 0 {
...
func UsageAddInterfaces(builder *flatbuffers.Builder, Interfaces flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(2, flatbuffers.UOffsetT(Interfaces), 0) }
func UsageStartInterfacesVector(builder *flatbuffers.Builder, numElems int) flatbuffers.UOffsetT { return builder.StartVector(4, numElems, 4)
}
