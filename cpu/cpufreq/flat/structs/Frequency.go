...
func FrequencyStart(builder *flatbuffers.Builder) { builder.StartObject(2) }
func FrequencyAddTimestamp(builder *flatbuffers.Builder, Timestamp int64) { builder.PrependInt64Slot(0, Timestamp, 0) }
func FrequencyAddCPU(builder *flatbuffers.Builder, CPU flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(1, flatbuffers.UOffsetT(CPU), 0) }
