...
func InfoStart(builder *flatbuffers.Builder) { builder.StartObject(24) }
...
func InfoAddApicID(builder *flatbuffers.Builder, ApicID int16) { builder.PrependInt16Slot(12, ApicID, 0) }
func InfoAddInitialApicID(builder *flatbuffers.Builder, InitialApicID int16) { builder.PrependInt16Slot(13, InitialApicID, 0) }
func InfoAddFPU(builder *flatbuffers.Builder, FPU flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(14, flatbuffers.UOffsetT(FPU), 0) }
func InfoAddFPUException(builder *flatbuffers.Builder, FPUException flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(15, flatbuffers.UOffsetT(FPUException), 0) }
func InfoAddCPUIDLevel(builder *flatbuffers.Builder, CPUIDLevel flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(16, flatbuffers.UOffsetT(CPUIDLevel), 0) }
func InfoAddWP(builder *flatbuffers.Builder, WP flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(17, flatbuffers.UOffsetT(WP), 0) }
func InfoAddFlags(builder *flatbuffers.Builder, Flags flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(18, flatbuffers.UOffsetT(Flags), 0) }
func InfoAddBogoMips(builder *flatbuffers.Builder, BogoMips float32) { builder.PrependFloat32Slot(19, BogoMips, 0) }
func InfoAddCLFlushSize(builder *flatbuffers.Builder, CLFlushSize flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(20, flatbuffers.UOffsetT(CLFlushSize), 0) }
func InfoAddCacheAlignment(builder *flatbuffers.Builder, CacheAlignment flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(21, flatbuffers.UOffsetT(CacheAlignment), 0) }
func InfoAddAddressSizes(builder *flatbuffers.Builder, AddressSizes flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(22, flatbuffers.UOffsetT(AddressSizes), 0) }
func InfoAddPowerManagement(builder *flatbuffers.Builder, PowerManagement flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(23, flatbuffers.UOffsetT(PowerManagement), 0) }
