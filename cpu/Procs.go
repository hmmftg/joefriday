...
func (rcv *Procs) Timestamp() int64 {
...
func ProcsStart(builder *flatbuffers.Builder) { builder.StartObject(2) }
func ProcsAddTimestamp(builder *flatbuffers.Builder, Timestamp int64) { builder.PrependInt64Slot(0, Timestamp, 0) }
func ProcsAddInfos(builder *flatbuffers.Builder, Infos flatbuffers.UOffsetT) { builder.PrependUOffsetTSlot(1, flatbuffers.UOffsetT(Infos), 0) }
