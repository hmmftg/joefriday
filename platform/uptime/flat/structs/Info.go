...
func InfoStart(builder *flatbuffers.Builder) { builder.StartObject(3) }
func InfoAddTimestamp(builder *flatbuffers.Builder, Timestamp int64) { builder.PrependInt64Slot(0, Timestamp, 0) }
func InfoAddTotal(builder *flatbuffers.Builder, Total float64) { builder.PrependFloat64Slot(1, Total, 0.0) }
func InfoAddIdle(builder *flatbuffers.Builder, Idle float64) { builder.PrependFloat64Slot(2, Idle, 0.0) }
